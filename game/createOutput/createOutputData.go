...
func (output *Output) createOutputData(documentWidth, documentHeight, scale float64) {
	output.createField(documentWidth, documentHeight, scale)
	output.createArrows(documentWidth, documentHeight, scale)
}
